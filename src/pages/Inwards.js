                  ...
                  {data?.map(row => {
                    return (
                      <tr class="border-b hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap ">{row.supplier_name}</td>
                        ...
                        <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap ">{row.date_of_supply}</td>
