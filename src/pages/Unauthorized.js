    ...
    <section className="bg-white font-Inter">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <Link to="/login" className="inline-flex text-white no-underline bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4 sm:ml-3">Back to Login</Link>
        </div>
      </div>
    </section>
