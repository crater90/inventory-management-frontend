            ...
            <div className="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
              ...
              <div className="w-full md:w-1/2">
                <form onSubmit={handleSearch} className="flex items-center">
                  ...
                  <div className="relative w-full">
                    <button
                      type="submit"
                      className="absolute cursor-pointer inset-y-0 left-0 flex items-center pl-3"
                    >
                      <svg
                        aria-hidden="true"
              ...
              {(userDetails.type === 0 || userDetails.type === 1) && (
                <div className="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
                  ...
                  <CSVLink
                    className="flex items-center no-underline justify-center px-4 py-2 text-sm font-medium text-white rounded-md bg-blue-600 hover:bg-blue-700"
                    {...csvReport}
                  >
                    Export Data
                  </CSVLink>
