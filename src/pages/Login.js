...
import bgImage from "../../public/pexels-scott-webb-593158.jpg";
...
function Login() {
  ...
  return (
    <section
      className="bg-slate-100 font-Inter"
      style={{
        backgroundImage:
          "../../public/pexels-scott-webb-593158.jpg(${bgImage})",
        ...
        <div className="w-full bg-white border border-slate-300 rounded-md shadow-sm md:mt-0 sm:max-w-md xl:p-0">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <button
                type="submit"
                className="w-full text-white bg-blue-500 hover:bg-blue-700 font-medium rounded-md text-sm px-5 py-2.5 text-center"
              >
                Sign in
              </button>
              <button
                type="button"
                className="w-full text-gray-500 hover:text-gray-700 font-medium rounded-md text-sm px-5 py-2.5 text-center border border-gray-300"
                onClick={handleReset}
              >
                Reset
              </button>
