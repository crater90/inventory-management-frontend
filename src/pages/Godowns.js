									...
									{data?.map(row => {
										return (
											<tr class="border-b hover:bg-gray-100">
												...
												<td class="px-4 py-2">
													<span class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded">{row.location}</span>
												</td>
												<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap ">{row.capacity}</td>
												<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">{row.manager}</td>
												<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">{row.start_date}</td>
												<td onClick={() => openEditModal(row.godown_Id)} class="px-2 py-2 font-medium text-gray-900 whitespace-nowrap cursor-pointer">
												...
												<td onClick={() => handleDelete(row.godown_Id)} class="px-2 py-2 font-medium text-gray-900 whitespace-nowrap cursor-pointer">
