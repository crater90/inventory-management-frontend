                  ...
                  {data?.map(row => {
                    return (
                      <tr class="border-b hover:bg-gray-100"> */}
                        ...
                        <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap ">{row.item_id}</td>
                        <td class="px-4 py-2">
                          <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded">{row.type === 1 ? 'admin' : 'employee'}</span>
                        </td>
                        <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">{row.itemName}</td>
