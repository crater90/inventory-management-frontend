...
function Outwards() {
  ...
  const columns_name = ["id", "product", "quantity", "total", "godown id", "delivered to", "delivery date"];
                  ...
                  {data?.map(row => {
                    return (
                      <tr class="border-b hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">{row.delivered_to}</td>
                        <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">{row.date_of_del}</td>
