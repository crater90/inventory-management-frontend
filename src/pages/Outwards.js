                  ...
                  {data?.map(row => {
                    return (
                      <tr key={row.transaction_Id} className="border-b hover:bg-gray-100">
                        ...
                        <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">{row.delivered_to}</td>
                        <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">{row.date_of_del}</td>
