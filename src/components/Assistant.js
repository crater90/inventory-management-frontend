...
const Assistant = () => {
  ...
  const steps = [
...

    {
      ...
      message:
        "Thank you for contacting us. For more queries feel free to reach out  simsupport@gmail.com",
...

    {
      ...
      options: [
        {
          value: "godownlocations",
          label: "Godown Locations",
          trigger: "godownlocations",
        },
  ...
  return (
    <div className="fixed right-0 bottom-0 mr-6 mb-6 my-2">
      {isOpen ? (
        <div className="rounded-lg shadow-lg bg-white w-80">
          <ChatBot headerComponent={<ChatHeader />} steps={steps} />
        </div>
      ) : (
        <button
