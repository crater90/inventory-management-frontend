...
function Modal({ modal, setModal, modal_data, modalData, setModalData }) {
  ...
  return (
    <div
      className={`${
        modal ? "block" : "hidden"
      } overflow-y-auto bg-gray-300/90 overflow-x-hidden fixed z-50 justify-center items-center w-full h-full md:inset-0 md:h-full`}
    >
        ...
        <div className="relative p-4 bg-white rounded-md border border-gray-200 shadow-sm sm:p-5">
          ...
          {modalData ? (
            <form onSubmit={handleSubmit(onSubmitEdit)}>
              ...
              <button
                type="submit"
                className="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center"
              >
                <svg
