...
function Table({ columns, name, data, row_keys }) {
	...
	return (
		<div class="sm:mt-2 px-4 mx-auto max-w-screen-2xl font-Inter lg:px-12">
			<Modal modal={modal} setModal={setModal} columns={columns} name={name} />
			<div class="relative overflow-hidden bg-white border border-gray-200 shadow-sm sm:rounded-md">
				<div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
					<div class="flex items-center flex-1 space-x-4">
						<h5 className="text-gray-500 font-bold mb-0">{name}</h5>
					</div>
					...
					<table class="w-full text-sm text-left text-gray-500">
						...
						<tbody>
							...
							<tr class="border-b hover:bg-gray-100">
								...
								<td class="px-4 py-2">
									<span class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded">Hyderabad</span>
								</td>
								<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap ">
									55
								</td>
								<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">Gagan</td>
								<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">17 Mar</td>
								<td onClick={handleEdit} class="px-2 py-2 font-medium text-gray-900 whitespace-nowrap cursor-pointer">
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 text-gray-700">
										<path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
									</svg>
							...
							<tr class="border-b hover:bg-gray-100">
								...
								<td class="px-4 py-2">
									<span class="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded">Chennai</span>
								</td>
								<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap ">
									150
								</td>
								<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">Ranit</td>
								<td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">1 Jan</td>
								<td onClick={handleEdit} class="px-2 py-2 font-medium text-gray-900 whitespace-nowrap cursor-pointer">
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 text-gray-700">
										<path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
									</svg>
